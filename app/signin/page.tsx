      ...
      <div className="h-[100vh] w-full flex justify-center items-center   bg-[url('/assets/signin-bg.png')] bg-cover bg-no-repeat bg-center bg-black ">
        <aside className=" w-full  max-w-md  ">
          <form action="" onSubmit={handleSubmit} className="signup-form p-6 ">
            <h1 className="text-left text-[#0466AE] font-bold text-3xl  m-0 mb-8">
              Sign In
            </h1>
            ...
            <div className="flex flex-col items-center ">
              <div className="bg-black-100 w-full p-2 flex items-center mb-3 rounded-t-xl rounded-b-xl border border-white  ">
                ...
                <FaUser className="text-white-500" color="#0466AE" m-2 />
                <input
                  type="text"
                  name="username"
                  id="username"
              ...
              <div className="bg-black-100 w-full p-2 flex items-center mb-3 rounded-t-xl rounded-b-xl border border-white  ">
                ...
                <FaLock className="text-white-500" color="#0466AE" m-2 />
                <input
                  type="password"
                  name="password"
                  id="password"
            ...
            <div className="w-64 mb-3 flex mt-2">
              <label
              ...
              >
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="mr-3 appearance-none border-[#565454] border w-[15px] h-[15px]  checked:bg-white "
                />
                Remember Me
              </label>
            </div>
            ...
            <button
              type="submit"
              className="bg-[#0466AE] text-white font-medium py-2 px-8 hover:text-black rounded-3xl  mt-2 mb-6"
            >
              {" "}
              Login{" "}
            </button>
            ...
            <br />
            <p className="text-white flex text-xs cursor-pointer text-center flex mt-5">
              Or,Login with
            ...
            <p className="text-white text-xs cursor-pointer mt-5">
              ...
              <a href="/signup">
                <span className="text-[#008BD9] px-3 ">Create One</span>
              </a>
            </p>
          </form>
        </aside>
